...
private DigitalInput chassis_LimitSwitch;
...
rightCANCoder = new CANCoder(6);
    ...
    * positive when Talon LEDs are green */
    ...
    public DigitalInput getLimitSwitch() {
        return chassis_LimitSwitch;
    }

    public void setLimitSwitch1(DigitalInput limitSwitch1) {
        this.chassis_LimitSwitch = limitSwitch1;
    }
    ...
    public void ArcadeDrive(double xSpeed, double zRotation, boolean squareInputs){
        ...
        //     turn = 0;
        diffDrive.setDeadband(0.1); /* deadband gamepad 10%*/
